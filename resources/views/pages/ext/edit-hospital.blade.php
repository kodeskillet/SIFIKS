...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Edit Rumah sakit</li>
        </ol>
    </section>
    ...
    <section class="content container-fluid">
        <div class="box box-primary container" style="padding-bottom:20px;">
            <br>
            {!! Form::open(['action' => 'HospitalController@update','method'=> 'POST', 'enctype' => 'multipart/data']) !!}
            <div class="form-group row">
                {{Form::label ('name','Nama Rumah Sakit',['class'=>'col-md-2 col-form-label text-md-right'])}}
                <div class="col-md-4">
                        {{Form::text ('name',$data['hospital']->name,['class'=>'form-control float-right','placeholder'=>'Ex:RS.Lavalette'])}}
                        @if($errors->has('name'))
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    {{Form::text ('address',$data['hospital']->address,['class'=>'form-control','placeholder'=>'Ex:Jl.Kalimosodo 12 no 9'])}}
