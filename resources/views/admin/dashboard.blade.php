...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="/administrator/" class="logo">
      ...
      <span class="logo-lg"><b>SIFIKS</b>administrator</span>
    </a>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="/administrator/obat"><i class="fa fa-circle-o"></i>Obat</a></li>
            <li><a href="/administrator/kesehatan"><i class="fa fa-circle-o"></i>Kesehatan</a></li>
            <li><a href="/administrator/penyakit"><i class="fa fa-circle-o"></i>Penyakit</a></li>
          </ul>
        </li>
        <li>
        ...
        <li>
          <a href="/administrator/pertanyaan/">
            <i class="fa fa-commenting"></i> <span>Pertanyaan</span>
          </a>
        </li>
        <li>
          <a href="../widgets.html">
